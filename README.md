...
| `create-cgu.sh` | Create ClusterGroupUpgrades for remediating non-compliant policies. Example: `./create-cgu.sh sno171` | - |
| `ssh0.sh` | Quick SSH access to cluster nodes using kubeconfig files. Example: `./ssh0.sh sno171` | - |